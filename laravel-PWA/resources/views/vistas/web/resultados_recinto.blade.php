            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                        ...
                                        @foreach($mesas as $mesa)
                                            <tr>
                                                ...
                                                <td class="text-center ">
                                                    <a href="{{url("resultados/$eleccion->id/$departamento->id/$provincia->id/$municipio->id/$recinto->id/$mesa->id")}}">
                        ...
                        <br>
                        <a href="{{url("/resultados/$eleccion->id/$departamento->id/$provincia->id/$municipio->id")}}">
                            <button class="btn btn-primary">
                                {{$municipio->nombre}}
                            </button>
                        </a>
