...
Route::middleware('auth')->group(function () {
    ...
    Route::get('admin/elecciones/resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}', 'Web\EleccionController@resultados_municipio');
    Route::get('admin/elecciones/resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}/{rec_id}', 'Web\EleccionController@resultados_recinto');
    Route::get('admin/elecciones/resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}/{rec_id}/{mesa_id}', 'Web\EleccionController@resultados_mesa');
...
Route::get('resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}', 'Web\WebController@resultados_municipio');
Route::get('resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}/{rec_id}', 'Web\WebController@resultados_recinto');
Route::get('resultados/{eleccion_id}/{dpto_id}/{prov_id}/{mun_id}/{rec_id}/{mesa_id}', 'Web\WebController@resultados_mesa');
